...
FetchContent_Declare(json URL https://github.com/nlohmann/json/releases/download/v3.11.3/json.tar.xz EXCLUDE_FROM_ALL OVERRIDE_FIND_PACKAGE)
...
#
#    if(NOT CMAKE_REQUIRED_QUIET)
#        message(STATUS "Fetching remote nlohmann from GitHub")
#    endif()
#
#    FetchContent_MakeAvailable(json)
#endif()
